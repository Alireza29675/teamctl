...
- `/teamctl:adjust` — open-ended "talk to it" command for evolving the team afterwards. Add a manager, scope a channel, wire telegram, retire an agent — described in plain English, applied as YAML edits.
